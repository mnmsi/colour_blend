...
const colorAddition = (prevColor, currentColor) => {
    ...
    // console.log("=====:91=====evaluatedResult:=====", evaluatedResult);
...
const doCalc = () => {
    ...
    // console.log("====:101:====oldColor:====", oldColor);
    return oldColor;
}
